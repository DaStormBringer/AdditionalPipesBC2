...
public class MutiPlayerProxyClient extends MutiPlayerProxy {
	...
	public void registerKeyHandler() {
		KeyHandler.laserKey = new KeyBinding("Toggle chunk loading boundries", AdditionalPipes.instance.laserKeyCode, AdditionalPipes.MODID);
		...
		ClientRegistry.registerKeyBinding(keyHandler.laserKey);
	}
