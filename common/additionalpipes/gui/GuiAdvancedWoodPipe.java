...
public class GuiAdvancedWoodPipe extends GuiContainer
{
	...
	{
		super.initGui();
		final int guiX = (width - xSize) / 2;
		final int guiY = (height - ySize) / 2;
	...
	protected void actionPerformed(GuiButton guibutton)
	{
		if (guibutton.id == 1)
		{
			final PacketAdditionalPipes packet = new PacketAdditionalPipes(NetworkHandler.ADV_WOOD_DATA, false);
