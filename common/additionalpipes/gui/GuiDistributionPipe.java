...
public class GuiDistributionPipe extends GuiContainer
{
	...
	protected int xSize;
	protected int ySize;
	private final GuiButton[] buttons = new GuiButton[18];
	public int guiX = 0;
	public int guiY = 0;
	...
	public void initGui()
	{
		...
		final int guiX = ((width - xSize) / 2) + 30;
		final int guiY = ((height - ySize) / 2) - 10;
	...
	{
		final int index = (guibutton.id - 1) / 3;
		...
		final PacketAdditionalPipes packet = new PacketAdditionalPipes(NetworkHandler.DIST_PIPE_DATA, true);
