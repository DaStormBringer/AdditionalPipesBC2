...
public abstract class PipeTeleport extends APPipe
{
	...
	private final boolean[] phasedBroadcastSignal = new boolean[4];
	...
	{
		if (pipe.isPublic || pipe.owner.equals(player.username) || player.capabilities.isCreativeMode) return true;
		return false;
	}
